...
(function () {
  ...
  let allVideos = [
    ...
    {
      name: "Sample from support",
      url: "https://media.axprod.net/TestVectors/v7-MultiDRM-SingleKey/Manifest.mpd",
      licenseToken:
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..OaOk2jS3KreIB4WCqBD4_0GI4S5Hb_yiWEORLRL-qCA",
    },
    {
      name: "My Video 1",
      url: "https://gateway.pinata.cloud/ipfs/QmYcKx3oWe2Qsyfhwt7upP7yBwKhSyJb9QvaK8EjQ2gwtN/Manifest.mpd",
      keys: [
        {
          keyId: "9ca81c2e-dfc5-413d-8a8b-17c502a32bf4",
        },
      ],
    },
    {
      name: "My Video 2",
      url: "https://gateway.pinata.cloud/ipfs/QmYz1DMB74bMqaqsMufn2xUyuDbvGpLn5vupxyrJqyxJXw/Manifest.mpd",
      keys: [
        {
          keyId: "9ca81c2e-dfc5-413d-8a8b-17c502a32bf4",
        },
    ...
    },
    {
      ...
      licenseToken:
        "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..DpwBd1ax4Z7P0cCOZ7ZJMotqVWfLFCj2DYdH37xjGxM",
    },
    {
  ...
  function verifyVideoIntegrity(video) {
    if (!video) throw new Error("A video was expected but was not present.");
    ...
    if (video.licenseToken && video.keys)
      throw new Error(
        "The video has both a hardcoded license token and a content key list - pick only one."
      );
    if (!video.licenseToken && !video.keys)
